...
const LeetCodeWrapped = () => {
    ...
    const questionsDone = Math.floor(tempData.totalSolved / tempData.totalQuestions * 100);
    const questionsRemain = 100 - questionsDone;
                ...
                <div className="stats shadow flex sm:flex overflow-hidden  sm:w-[550px]  items-center justify-center rounded-none">
                    <div className='flex        '>
                        <div className="stat ">
                            ...
                            <div className="stat-value text-[#FF8866]">{tempData.fullName.split(' ')[0]}</div>
                        ...
                        <div className="stat pl-3">
                            ...
                            <div className="stat-value">{questionsDone}%</div>
                            <div className="stat-title">Questions Done</div>
                            <div className="stat-desc text-[secondary]">{questionsRemain}% Questions remains</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="stats shadow flex sm:flex-col overflow-hidden sm:w-[550px]  items-center justify-center rounded-none">
                    <div className='sm:flex '>
                        <div className="stat">
                            ...
                            <div className="stat-value text-secondary">{tempData.Views}</div>
                        ...
                        <div className="stat">
                            ...
                            <div className="stat-value text-primary">{tempData.Solution}</div>
                        ...
                        <div className="stat">
                            ...
                            <div className="stat-value text-[#FCD53F]">{tempData.Reputation}</div>
                ...
                <div className="stats shadow flex sm:flex-col overflow-hidden sm:w-[550px] items-center justify-center rounded-none ">
                    <div className='sm:flex '>
                        <div className="stat">
                            ...
                            <div className="stat-value text-[#03AAEE]">{tempData.Solution}</div>
                        ...
                        <div className="stat">
                            ...
                            <div className="stat-value text-[#00A96E]">{tempData.activeDays}</div>
                        ...
                        <div className="stat">
                            ...
                            <div className="stat-value text-[#B2F302]">{tempData.maxStreak}</div>
